...
const initialProjectData = [
  {
    ...
    area: '7,550.00',
    projectHolder: 'ASAD MUJAHID',
    allocationDate: '2025-09-19',
    siteSurveyStart: '2025-09-20',
    siteSurveyEnd: '2025-09-20',
    contact: '',
    headCount: 'DONE',
    proposalStart: '2025-09-24',
    proposalEnd: '2025-09-28',
    '3dStart': '2025-10-03',
    '3dEnd': '2025-11-03',
    tenderArchStart: '',
    tenderArchEnd: '',
            ...
            <Table className="min-w-full border-collapse border border-gray-400 text-xs">
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead rowSpan={2} className="border border-gray-400 text-center align-middle w-[70px]">Head Count / Requirement</TableHead>
