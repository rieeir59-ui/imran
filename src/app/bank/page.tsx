        ...
        <Card className="printable-card">
            ...
            <CardContent>
                <Tabs defaultValue="section-1" className="w-full">
                    <TabsList className="h-auto flex-wrap no-print">
                        {fileIndexItems.map((item) => (
                            <TabsTrigger key={item.id} value={item.id}>{item.no}. {item.title}</TabsTrigger>
                        ))}
                    </TabsList>
                    ...
                    <TabsContent value="section-5">
                     ...
                     <TabsContent value="section-6">
                        <Card>
                            <CardHeader><CardTitle>List of Services</CardTitle></CardHeader>
                            <CardContent>
                                <p>Please refer to the <TabsTrigger value="section-1" className="text-primary underline">Project Checklist section</TabsTrigger>.</p>
                            </CardContent>
                        </Card>
                    </TabsContent>
                    
                    <TabsContent value="section-7">
                        <Card>
