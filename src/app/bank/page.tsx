...
const Section18 = () => (
    <Card>
        ...
        <CardContent>
             <h3 className="text-xl font-bold text-center mb-4">Architectural Project Timeline – Phase-wise Breakdown</h3>
            <div className="space-y-6">
                <div>
                    <h4 className="text-lg font-semibold mb-2">1. Project Initiation & Site Studies</h4>
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Client Brief</li>
                        <li>Project Scope and Area Statements</li>
                        <li>Topographic / Preliminary Survey</li>
                        <li>Geotechnical Investigation and Report</li>
                    </ul>
                </div>
                <div>
                    <h4 className="text-lg font-semibold mb-2">2. Concept Design Stage</h4>
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Concept Design Development</li>
                        <li>Concept Plans and Supporting Drawings</li>
                        <li>Interior Design Concept Development</li>
                        <li>Finalization of Concept Design Report</li>
                        <li>Client Approval on Concept Design</li>
                    </ul>
                </div>
                <div>
                    <h4 className="text-lg font-semibold mb-2">3. Preliminary Design Stage</h4>
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Preliminary Design and Layout Plan – Cycle 1</li>
                        <li>Initial Engineering Coordination (Structural / MEP)</li>
                        <li>Layout Plan – Cycle 2 (Refined Based on Feedback)</li>
                        <li>Environmental Study (if applicable)</li>
                        <li>Authority Pre-Consultation / Coordination (LDA, CDA, etc.)</li>
                        <li>3D Model Development</li>
                        <li>Elevations and Sections</li>
                        <li>Preliminary Interior Layout</li>
                        <li>Preliminary Engineering Design</li>
                        <li>Finalization of Preliminary Design Report</li>
                        <li>Client Comments / Approval on Preliminary Design</li>
                    </ul>
                </div>
                 <div>
                    <h4 className="text-lg font-semibold mb-2">4. Authority Submission Stage</h4>
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Preparation of Submission Drawings</li>
                        <li>Submission to LDA / CDA / Other Relevant Authority</li>
                        <li>Application for Stage-1 Approval</li>
                        <li>Authority Approval Process (Review, Comments, Compliance)</li>
                        <li>Receipt of Authority Approval (Stage-1)</li>
                    </ul>
                </div>
                <div>
                    <h4 className="text-lg font-semibold mb-2">5. Detailed Design and Tender Preparation Stage</h4>
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Detailed Architectural Design</li>
                        <li>Detailed Interior Layout</li>
                        <li>Detailed Engineering Designs (Structural / MEP)</li>
                        <li>Draft Conditions of Contract</li>
                        <li>Draft BOQs and Technical Specifications</li>
                        <li>Client Comments and Approvals on Detailed Design</li>
                        <li>Finalization of Detailed Design</li>
                    </ul>
                </div>
                <div>
                    <h4 className="text-lg font-semibold mb-2">6. Construction Design and Tender Finalization Stage</h4>
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Construction Design and Final Tender Preparation</li>
                        <li>Architectural Construction Drawings</li>
                        <li>Engineering Construction Drawings</li>
                        <li>Final Tender Documents</li>
                        <li>Client Comments / Approval on Final Tender Documents</li>
                        <li>Tender Documents Ready for Issue</li>
                    </ul>
                </div>
                 <div>
                    <h4 className="text-lg font-semibold mb-2">7. Interior Design Development Stage</h4>
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Final Interior Design Development</li>
                        <li>Interior Layout Working Details</li>
                        <li>Interior Thematic Mood Board and Color Scheme</li>
                        <li>Ceiling Detail Design Drawings</li>
                        <li>Built-in Feature Details</li>
                        <li>Partition and Pattern Detail Drawings</li>
                        <li>Draft Interior Design Tender</li>
                        <li>Client Comments / Approval on Interior Design Development</li>
                        <li>Client Comments / Approval on Interior Design Tender</li>
                        <li>Finalization of Interior Design Tender</li>
                    </ul>
                </div>
                <div>
                    <h4 className="text-lg font-semibold mb-2">8. Procurement & Appointment Stage</h4>
                    <ul className="list-disc pl-5 space-y-1">
                        <li>Procurement of Main Contractor</li>
                        <li>Contract Award / Mobilization</li>
                    </ul>
                </div>
            </div>
        </CardContent>
...
const Section19 = () => (<Card><CardHeader><CardTitle>Project Application Summary</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
const Section20 = () => (<Card><CardHeader><CardTitle>Continuation Sheet</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
...
const Section22 = () => (<Card><CardHeader><CardTitle>Preliminary Project Budget</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
const Section23 = () => (<Card><CardHeader><CardTitle>Bill Of Quantity</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
const Section24 = () => (<Card><CardHeader><CardTitle>Rate Analysis</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
const Section25 = () => (<Card><CardHeader><CardTitle>Change Order</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
const Section26 = () => (<Card><CardHeader><CardTitle>Application and Certificate for Payment</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
const Section27 = () => (<Card><CardHeader><CardTitle>Instruction Sheet</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
...
const Section30 = () => (<Card><CardHeader><CardTitle>Consent of Surety</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
const Section31 = () => (<Card><CardHeader><CardTitle>Total Package of Project</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
const Section32 = () => (<Card><CardHeader><CardTitle>Architects Supplemental Instructions</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
const Section33 = () => (<Card><CardHeader><CardTitle>Construction Change Director</CardTitle></CardHeader><CardContent>...</CardContent></Card>);
    ...
    return (
        <main className="p-4 md:p-6 lg:p-8">
            <div className="flex justify-between items-center mb-6 no-print">
                ...
                <h1 className="text-2xl font-bold">Bank Branches - File Index</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                                        ...
                                        <li key={item.id}>
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    activeSection === item.id ? "bg-primary text-primary-foreground font-semibold" : "hover:bg-accent"
                                                )}
                                            >
                                                {item.no}. {item.title}
                                            </button>
                ...
                <div className="md:col-span-3">
                    <div ref={(el) => (sectionRefs.current[activeSection] = el)}>
                        {renderSection()}
                    </div>
                </div>
            </div>
