...
import { ArrowLeft, DraftingCompass, Lamp, LayoutList, Hammer, Zap, Wrench } from 'lucide-react';

const drawingCategories = [
    { title: 'Architectural Drawings', href: '/architectural-drawings', icon: DraftingCompass },
